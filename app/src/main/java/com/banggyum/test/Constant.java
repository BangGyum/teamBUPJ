...
public class Constant {
    ...
    public static final String MapUpdate_URL = BASE_PATH + "project/updateMap.php";
    public static final String MapAllSelect_URL = BASE_PATH + "project/getAllMap.php";

    public static final String AlarmCREATE_URL = BASE_PATH + "project/addAlarm.php";
    public static final String AlarmAllSelect_URL = BASE_PATH + "project/getAllAlarm.php";
